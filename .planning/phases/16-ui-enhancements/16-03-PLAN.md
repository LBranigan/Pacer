...
Purpose: Per CONTEXT.md: "Conservative WCPM value = underpromise philosophy — better to report lower and be accurate". Teachers see uncertainty in the data.
...
Note: Caller (app.js) needs to pass disfluencySummary and safetyData. For graceful degradation, check with optional chaining.
  </action>
  <verify>
